...
### Concept
1. How does JVM (jave virtual machine) work?
2. OO
3. Multi-thread
4. build-in classic data type, like String, Math, System etc. java.io stream concepts.
5. Ant and Maven build
6. Unit testing
7. XML
8. Framework, Spring
9. dependency injection
10. Improvements on language from major version changes (Generics, Annotations, Enums, ...)
11. design pattern
12. RESTful
13. servers, like Tomcat

### Memory management

##### Heap vs Stack
All objects are created in heap
When call a method or thread, A part of stack will be allocated for the method.
Stack only keep primitive and reference to objects.
Heap is global area, but stack is not.

...
func TestInsertionSort(t *testing.T) {
	...
	ct, et := InsertionSort(case1)
	fmt.Println(case1, ct, et)

	ct, et = InsertionSort(case2)
	fmt.Println(case2, ct, et)

	ct, et = InsertionSort(case3)
	fmt.Println(case3, ct, et)

	ct, et = InsertionSort(case4)
	fmt.Println(case4, ct, et)

	ct, et = InsertionSort(case5)
	fmt.Println(case5, ct, et)

	ct, et = InsertionSort(case6)
	fmt.Println(case6, ct, et)

	ct, et = InsertionSort(case7)
	fmt.Println(case7, ct, et)

	ct, et = InsertionSort(case8)
	fmt.Println(case8, ct, et)

	ct, et = InsertionSort(case9)

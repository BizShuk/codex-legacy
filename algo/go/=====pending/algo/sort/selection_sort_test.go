...
func TestSelectionSort(t *testing.T) {
	...
	ct, et := SelectionSort(case1)
	fmt.Println(case1, ct, et)

	ct, et = SelectionSort(case2)
	fmt.Println(case2, ct, et)

	ct, et = SelectionSort(case3)
	fmt.Println(case3, ct, et)

	ct, et = SelectionSort(case4)
	fmt.Println(case4, ct, et)

	ct, et = SelectionSort(case5)
	fmt.Println(case5, ct, et)

	ct, et = SelectionSort(case6)
	fmt.Println(case6, ct, et)

	ct, et = SelectionSort(case7)
	fmt.Println(case7, ct, et)

	ct, et = SelectionSort(case8)
	fmt.Println(case8, ct, et)

	ct, et = SelectionSort(case9)

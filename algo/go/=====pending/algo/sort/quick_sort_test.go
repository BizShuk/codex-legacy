...
func TestQuickSort(t *testing.T) {
	...
	ct, et := QuickSort(case1)
	fmt.Println(case1, ct, et)

	ct, et = QuickSort(case2)
	fmt.Println(case2, ct, et)

	ct, et = QuickSort(case3)
	fmt.Println(case3, ct, et)

	ct, et = QuickSort(case4)
	fmt.Println(case4, ct, et)

	ct, et = QuickSort(case5)
	fmt.Println(case5, ct, et)

	ct, et = QuickSort(case6)
	fmt.Println(case6, ct, et)

	ct, et = QuickSort(case7)
	fmt.Println(case7, ct, et)

	ct, et = QuickSort(case8)
	fmt.Println(case8, ct, et)

	ct, et = QuickSort(case9)
